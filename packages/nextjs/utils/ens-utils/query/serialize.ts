...
export function serialize(
  ...
  return JSON.stringify(
    ...
    createReplacer(function initialReplacer(this: any, key, replacerValue_) {
      ...
      if (typeof replacerValue === "bigint") replacerValue = { __type: "bigint", value: replacerValue_.toString() };
      if (value instanceof Map) replacerValue = { __type: "Map", value: Array.from(replacerValue_.entries()) };
